(function () {
  ...
  function initBadge() {
    ...
    const companyName = sanitizeCompanyName(forcedCompany || deriveCompanyName(targetURL)) || "Company";
    ...
    const ROTATION = [
      { text: "Company verified by Welo", duration: 4200 },
      { text: `See why ${companyName} is secure`, duration: 4200 },
      { text: "View verified reviews", duration: 4200 },
    ];
        ...
        <div class="welo-modal-header">
          ...
          <div class="welo-header-buttons">
            <button class="welo-open-btn" id="welo-open-btn">
              <img src="https://cdn.prod.website-files.com/672c7e4b5413fe846587b57a/68553e0f860d1da7b26f8f9f_Vector.svg" width="14" height="14" alt="Open" />
    ...
    style.innerHTML = `
      ...
      .welo-badge-wrap{
        ...
        /* ✅ prevents iOS text autosizing that can mess up heights */
      ...
      /* ✅ no ellipsis (desktop + mobile) + safe descenders */
      .welo-title{
        display:block;
        font-size:16px;
        font-weight:600;
        ...
        /* ✅ safer line-height for descenders (g,p,y) */
        line-height:1.22;
