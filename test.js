  ...
  function initBadge() {
      ...
      <div class="welo-modal" role="dialog" aria-modal="true" aria-label="Welo Badge">
        <div class="welo-modal-header">
          ...
          <div class="welo-header-buttons">
            <button class="welo-open-btn" id="welo-open-btn" type="button" title="Apri Welo Page">
            ...
            <button class="welo-fullscreen-btn" id="welo-fullscreen-btn" type="button" title="Espandi a schermo intero" aria-pressed="false">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    if (!document.getElementById("welo-badge-style")) {
      ...
      style.innerHTML = `
        ...
        .welo-close-btn{
          ...
          font-weight:500;
          gap:6px;
          min-height:30px;            /* leggermente più basso */
        }
        ...
        @media (max-width: 768px){
          ...
          /* ✅ header ancora più compatto su mobile */
          .welo-modal-header{
            padding: 6px 12px;
            min-height: 38px;
            background: var(--welo-header-bg);
    ...
    function setFullscreenUI(isOn) {
      ...
      if (isOn) {
        ...
        `;
        fullscreenBtn.title = "Espandi a schermo intero";
      }
    }
